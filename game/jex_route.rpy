...
label start:
    ...
    x "But... For some reason, you were the only person who didn't immediently fall for me and chose to stay for this long. Why?"
    ...
    y "I want us to win the tournement as much as the next club member."
    y "If we don't then that's okay too!"
    y "Come on! Let's practice together, Jex. Even if we aren't at our best, it's nice to just be here with someone."
